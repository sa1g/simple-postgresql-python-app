...
def connect():
    ...
    try:
        ...
        conn = psycopg2.connect(
            database="assignment3", user="assignment3", host="localhost", password="assignment3")
...
def get_random_numbers_in_list():
    ...
    # used in step 3
    # TODO convert to generator (see below yield)
...
def get_age():
    ...
    # used in Step 3
    for i in range(N):
        # hard coded values should go all togheter in a config section
...
def sailor_list():
    ...
    # the loop befor was C style - slower than this one
    # with this one I can go back to the functions and
    # make them return generators instead of list,
    # this avoids storing data in memory, which is uselss for this task
    # zip stop at the shortest list
